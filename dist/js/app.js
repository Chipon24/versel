(() => {
    ...
    document.addEventListener("DOMContentLoaded", (async () => {
        ...
        try {
            ...
            if (Array.isArray(post.content)) post.content.forEach((block => {
