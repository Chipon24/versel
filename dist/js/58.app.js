(self["webpackChunkfls_start"] = self["webpackChunkfls_start"] || []).push([ [ 58 ], {
    58: (module, __unused_webpack_exports, __webpack_require__) => {
        module.exports = __webpack_require__(377).EventSourcePolyfill;
    },
 ...
 */        (function(global) {
            ...
            TextDecoderPolyfill.prototype.decode = function(octets) {
                ...
                function octetsCount(bitsNeeded, codePoint) {
                    if (bitsNeeded === 6 * 1) return codePoint >> 6 > 15 ? 3 : codePoint > 31 ? 2 : 1;
                ...
                for (var i = 0; i < octets.length; i += 1) {
                    var octet = octets[i];
                    if (bitsNeeded !== 0) if (octet < 128 || octet > 191 || !valid(codePoint << 6 | octet & 63, bitsNeeded - 6, octetsCount(bitsNeeded, codePoint))) {
                        bitsNeeded = 0;
                        codePoint = REPLACER;
                    ...
                    if (bitsNeeded === 0) if (codePoint <= 65535) string += String.fromCharCode(codePoint); else {
            ...
            XHRWrapper.prototype.open = function(method, url) {
                ...
                var onFinish = function(type, event) {
                    ...
                    if (state === 1 || state === 2 || state === 3) {
                        ...
                        that.readyState = 4;
                        if (type === "load") that.onload(event); else if (type === "error") that.onerror(event); else if (type === "abort") that.onabort(event); else throw new TypeError;
                        that.onreadystatechange();
                    }
                };
                var onReadyStateChange = function(event) {
                    if (xhr != void 0) if (xhr.readyState === 4) {
            ...
            FetchTransport.prototype.open = function(xhr, onStartCallback, onProgressCallback, onFinishCallback, url, withCredentials, headers) {
                ...
                fetch(url, {
                    ...
                    return new Promise((function(resolve, reject) {
                        var readNextChunk = function() {
                            reader.read().then((function(result) {
                                if (result.done) resolve(void 0); else {
                    ...
                    if (error.name === "AbortError") return; else return error;
                })).then((function(error) {
            ...
            EventTarget.prototype.dispatchEvent = function(event) {
                ...
                if (typeListeners != void 0) {
                    ...
                    for (var i = 0; i < length; i += 1) {
                        ...
                        try {
                            if (typeof listener.handleEvent === "function") listener.handleEvent(event); else listener.call(this, event);
                        } catch (e) {
                            throwError(e);
                        }
                    }
            ...
            EventTarget.prototype.removeEventListener = function(type, listener) {
                ...
                if (typeListeners != void 0) {
                    ...
                    if (filtered.length === 0) delete listeners[type]; else listeners[type] = filtered;
                }
            };
            function Event(type) {
                this.type = type;
            ...
            function start(es, url, options) {
                ...
                var onProgress = function(textChunk) {
                    if (currentState === OPEN) {
                        ...
                        for (var position = 0; position < chunk.length; position += 1) {
                            ...
                            if (state === AFTER_CR && c === "\n".charCodeAt(0)) state = FIELD_START; else {
                                ...
                                if (c === "\r".charCodeAt(0) || c === "\n".charCodeAt(0)) {
                                    if (state !== FIELD_START) {
                                        ...
                                        if (field === "data") {
                                            dataBuffer += "\n";
                                            dataBuffer += value;
                                        } else if (field === "id") lastEventIdBuffer = value; else if (field === "event") eventTypeBuffer = value; else if (field === "retry") {
                                    ...
                                    if (state === FIELD_START) {
                                        if (dataBuffer !== "") {
                                            ...
                                            es.dispatchEvent(event);
                                            if (eventTypeBuffer === "open") fire(es, es.onopen, event); else if (eventTypeBuffer === "message") fire(es, es.onmessage, event); else if (eventTypeBuffer === "error") fire(es, es.onerror, event);
                ...
                var onTimeout = function() {
                    ...
                    state = FIELD_START;
                    var requestURL = url;
                    if (url.slice(0, 5) !== "data:" && url.slice(0, 5) !== "blob:") if (lastEventId !== "") {
                        var i = url.indexOf("?");
                    ...
                    if (headers != void 0) for (var name in headers) if (Object.prototype.hasOwnProperty.call(headers, name)) requestHeaders[name] = headers[name];
                    try {
            ...
            (function(factory) {
                ...
                } else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ exports ], __WEBPACK_AMD_DEFINE_FACTORY__ = factory, 
